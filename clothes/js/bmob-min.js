...
(function(a) {
	...
	d._traverse = function(g, h, f) {
		...
		if(g instanceof d.Relation || g instanceof d.File || g instanceof d.File2) {
			return h(g)
		}
		if(d._.isArray(g)) {
...
(function(a) {
	...
	b.extend(c.Object.prototype, c.Events, {
		...
		_resetCacheForKey: function(e) {
			...
			if(b.isObject(f) && !(f instanceof c.Object) && !(f instanceof c.File) && !(f instanceof c.File2)) {
